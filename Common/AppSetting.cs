...
namespace Common
{
    public static class AppSetting
    {
        ...
        /// JWT有效期(分钟=默认120)
        /// </summary>
        public static int ExpMinutes { get; private set; } = 720;
        ...
        public static void Init(IServiceCollection services, IConfiguration configuration)
        {
            ...
            //services.Configure<CAS>(configuration.GetSection("CAS"));
           ...
           // CreateMember = provider.GetRequiredService<IOptions<CreateMember>>().Value ?? new CreateMember();
            ...
            ExpMinutes = (configuration["ExpMinutes"] ?? "720").GetInt();
            ...
            //     _connection.DbConnectionString = _connection.DbConnectionString;
           ...
           // CAS = provider.GetRequiredService<IOptions<CAS>>().Value ?? new CAS();
    ...
    //public class CAS
    //{
    //    public string CaserverLogin { get; set; }
    //    public string CaserverUser { get; set; }
    //    public string ServiceDomain { get; set; }
    //    public string ServiceDomainLogin { get; set; }
    //}
}
